...
class IPhone extends SmartPhone {
  ...
  remainingAmount(priceIHave){
    ...
    this.price = priceIHave-this.price;
    return initialPrice>priceIHave ? "Customer can't able to buy a phone due to insufficient amount" : this.price <=0 ?"Customer has no more amount" :"Customer has remaining Rs." + this.price + " after buying an iphone";
  }
}
